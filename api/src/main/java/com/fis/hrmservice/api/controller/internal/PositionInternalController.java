...
public class PositionInternalController {
  ...
  @PostMapping("/by-ids")
  @Internal
  public ResponseApi<List<Long>> getExistingPositionIds(@RequestBody List<Long> positionIds) {
    return ResponseApi.ok(positionUseCase.findExistingPositionIds(positionIds));
  }
}
